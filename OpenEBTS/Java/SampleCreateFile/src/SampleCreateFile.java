...
public class SampleCreateFile
{
	...
	public static void main(String[] args)
	{
		...
		sPathOutput = sFolderSamples + "/SampleCreateFile_out.txt"; 
		...
		// will allow us to refer to field using their mnemonics.
		sbParseError = new StringBuffer("");	// setup to receive parsing error
