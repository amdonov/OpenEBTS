...
// Turn off unavoidable compiler warnings
	...
	#pragma warning (disable : 4996) // typedef name used as synonym for class name
#endif
...
#define SS_IS_INTRESOURCE(_r) (false)
	...
	#else
        #define SS_IS_INTRESOURCE(_r) ((((ULONG_PTR)(_r)) >> 16) == 0)
	#endif
#endif
...
//
//      Note however that this ONLY works for Format(), not sprintf_s, fprintf, 
...
public:
	...
	bool TryLoad(const void* pT)
	{
		...
		{
			UINT nId = LOWORD(reinterpret_cast<DWORD_PTR>(pT));
			if ( !LoadString(nId) )
			{
...
//		}
	...
	//           
	// DESCRIPTION:
	//		This function does sprintf_s/wsprintf style formatting on CStdStringA
	...
	//           
	// DESCRIPTION:
	//		This function formats the string with sprintf_s style format-specs. 
