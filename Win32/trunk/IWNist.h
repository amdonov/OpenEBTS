...
IWNIST_API int WINAPI IWvGetTransactionCategories(
	CIWVerification* IWVer, /* Verification Pointer */
...
IWNIST_API int WINAPI IWvGetTransactionTypes(
	CIWVerification* IWVer, /* Verification Pointer */
...
IWNIST_API char* WINAPI IWGetNISTCode(
  int nType, 
  int nFieldID, 
  int nParentField = 0,
  BOOL bGetDesc = FALSE
...
IWNIST_API char* WINAPI IWGetNISTDesc(
  int nType, 
  int nFieldID, 
  int nParentField = 0
 );

IWNIST_API char* WINAPI IWGetNISTCode2(
  CIWTransaction* IWTrans,    /* Transaction Pointer */
  int nType, 
  int nFieldID, 
  int nParentField = 0,
...
IWNIST_API char* WINAPI IWGetNISTDesc2(
  CIWTransaction* IWTrans,    /* Transaction Pointer */
  int nType, 
  int nFieldID, 
  int nParentField = 0
...
IWNIST_API int WINAPI IWGetErrorInfo(
  CIWTransaction* IWTrans,    /* Transaction Pointer       */
  int Index,                  /* Index value (zero based)  */
  const char** AdditionalInfo,/* Additional error data
                                 (reserved for future use) */
  int* ErrorLocationCount     /* Number of error locations */
);

IWNIST_API int WINAPI IWGetErrorLocation(
  CIWTransaction* IWTrans,    /* Transaction Pointer */
  int Index,                  /* Index value  (zero based)*/
  int ErrorLocationIndex,     /* Error Location Index (zero based)*/
  const char** Data,          /* Data from Field */
  const char** Mnemonic,      /* Field Identifier */
  int* RecordType,            /* Record Type */
  int* RecordIndex,           /* Record Index */
  int* RecordIDC,             /* Record IDC (-1 if unassigned )*/
  int* Field,                 /* Field Number */
  int* Subfield,              /* Subfield number */
  int* Item,                  /* Item Number */
...
IWNIST_API int WINAPI IWGetErrorString(
