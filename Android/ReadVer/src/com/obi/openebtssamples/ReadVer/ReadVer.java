package com.obi.openebtssamples.ReadVer;
...
public class ReadVer extends Activity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
		...
		// Because the processing time would be very long, we only do this for the
		// first MNU. 
		//for (int c = 0; c < cats.getTransactionCategoryCount(); c++)
		for (int c = 0; c < 1; c++)
		{
